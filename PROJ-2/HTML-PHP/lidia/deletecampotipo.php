    ...
    <div class="container">
      <div class="header">
        <ul class="nav nav-pills pull-right" role="tablist">
          <li role="presentation"><a href="insertcampo.php?nometipo=$_SESSION["nometipo"]"> Inserir Campos </a></li>
          <li role="presentation" class="active"><a href="deletecampotipo.php?nometipo=$_SESSION["nometipo"]"> Apagar Campo de Tipo </a></li>
